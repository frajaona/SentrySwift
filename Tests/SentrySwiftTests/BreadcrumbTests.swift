...
final class BreadcrumbTests: XCTestCase {
    ...
    func testNavigationBreadcrumb() {
        let breadcrumb = Breadcrumb.makeNavigationBreadcrumb(from: "launch", to: "view")
    ...
    func testHTTPBreadcrumb() {
        let breadcrumb = Breadcrumb.makeHttpBreadcrumb(url: "dcvz.io", method: "GET", statusCode: 200, reason: "OK")
    ...
    static var allTests = [
        ("testNavigationBreadcrumb", testNavigationBreadcrumb),
        ("testHTTPBreadcrumb", testHTTPBreadcrumb),
        ("testRequestDict", testRequestDict),
    ]
}
