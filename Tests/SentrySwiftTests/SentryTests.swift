...
class SentryTests: XCTestCase {
    ...
    static var allTests = [
        ("testCaptureMessageMissingDSN", testCaptureMessageMissingDSN),
        ("testCaptureErrorMissingDSN", testCaptureErrorMissingDSN),
        ("testAddingBreadcrumbs", testAddingBreadcrumbs),
        ("testClearingBreadcrumbs", testClearingBreadcrumbs),
    ]
}
