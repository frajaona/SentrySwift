...
public struct Breadcrumb: Equatable {
    ...
    public static func ==(lhs: Breadcrumb, rhs: Breadcrumb) -> Bool {
...
public extension Breadcrumb {
    ...
    static func makeNavigationBreadcrumb(from: String, to: String) -> Breadcrumb {
    ...
    static func makeHttpBreadcrumb(url: String, method: String, statusCode: Int, reason: String) -> Breadcrumb {
